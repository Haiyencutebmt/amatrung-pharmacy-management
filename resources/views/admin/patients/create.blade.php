...
@section('title', 'Thêm Bệnh Nhân — AmaTrung')
@section('page-title', 'Thêm Bệnh Nhân Mới')

@section('content')
<div style="max-width: 1000px; margin: 0 auto;">
    <div style="margin-bottom: 2rem;">
        <a href="{{ route('admin.patients.index') }}" class="btn btn-secondary" style="background: #fff;">
    ...
    <div class="card" style="padding: 2.5rem; border: none; box-shadow: 0 10px 40px rgba(0,0,0,0.04);">
        <form action="{{ route('admin.patients.store') }}" method="POST">
            ...
            <div id="guardian_block" style="display: {{ old('is_guardian_phone') ? 'block' : 'none' }}; margin-top: 3rem; background: #fcfcfd; border-radius: 1.5rem; padding: 2rem; border: 1px solid #f1f5f9;">
                <div style="display: flex; align-items: center; gap: 0.75rem; margin-bottom: 1.5rem;">
                    ...
                    <h3 style="margin: 0; font-size: 1.1rem; color: #1e3a5f; font-weight: 700;">Thông tin người giám hộ <span style="font-weight: 400; color: #94a3b8; font-size: 0.85rem; margin-left: 0.5rem;">(Nếu bệnh nhân là trẻ em hoặc người già)</span></h3>
                </div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="relationship" id="relationship" class="form-input" value="{{ old('relationship') }}" placeholder="VD: Bố, Mẹ, Con cái...">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group" style="margin-top: 2rem;">
                ...
                <textarea name="note" id="note" class="form-input" rows="4" placeholder="Nhập các lưu ý quan trọng về bệnh nhân (nếu có)...">{{ old('note') }}</textarea>
            </div>

            <div style="display: flex; gap: 1rem; margin-top: 3rem; justify-content: flex-end; border-top: 1px solid #f1f5f9; padding-top: 2rem;">
                <a href="{{ route('admin.patients.index') }}" class="btn btn-secondary" style="background: #fff; min-width: 120px;">Hủy bỏ</a>
