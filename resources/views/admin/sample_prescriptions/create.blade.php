...
@section('title', 'Thêm Bài Thuốc Mẫu — AmaTrung')
@section('page-title', 'Tạo Bài Thuốc Mẫu Mới')
...
<div style="display: grid; grid-template-columns: 1.5fr 1fr; gap: 2rem; margin-top: -1rem;">
    ...
    <div class="main-card">
        <form action="{{ route('admin.sample-prescriptions.store') }}" method="POST" id="samplePrescriptionForm">
            @csrf
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem; margin-bottom: 1.5rem;">
                <div class="form-group">
                    ...
                    <input type="text" name="name" id="name" class="form-input" value="{{ old('name') }}" placeholder="VD: Bát Trân Thang, Độc Hoạt Tang Ký Sinh..." required>
                </div>
                <div class="form-group">
                    <label for="suggested_condition" class="form-label">Chỉ định / Triệu chứng phù hợp</label>
                    <input type="text" name="suggested_condition" id="suggested_condition" class="form-input" value="{{ old('suggested_condition') }}" placeholder="VD: Khí huyết lưỡng hư, đau nhức xương khớp...">
                </div>
            </div>

            <div class="form-group" style="margin-bottom: 1.5rem;">
                <label for="usage_instruction" class="form-label">Cách dùng tổng quát mặc định</label>
                <input type="text" name="usage_instruction" id="usage_instruction" class="form-input" value="{{ old('usage_instruction') }}" placeholder="VD: Sắc ngày 1 thang, chia 2 lần sáng/chiều sau ăn ấm...">
            </div>
            ...
            <div style="display: flex; gap: 1rem; justify-content: flex-end; border-top: 1px solid #f1f5f9; padding-top: 1.5rem;">
                ...
                <button type="submit" class="btn-save">💾 Lưu Bài Thuốc Mẫu</button>
            </div>
        </form>
    </div>
